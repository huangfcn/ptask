...
def get_label2id_fixed() -> Dict[str, int]:
    """id is 1 start"""
    labels_str = ['person']
    labels_ids = list(range(1, len(labels_str)+1))
    return dict(zip(labels_str, labels_ids))
...
def convert_xmls_to_cocojson(annotation_paths: List[str],
    ...
    nimages_person, nimages_total = 0, 0
    ...
    print("%d out of %d images with persons." % (nimages_person, nimages_total))
...
def main():
    ...
    label2id = get_label2id_fixed() # get_label2id(labels_path=args.labels)
